...
import type { ZoomSpringState } from "@/lib/effects/spring";
...
export class CanvasRenderer {
	...
	height: number;
	fps: FrameRate;
	/** Magic camera spring-chase state — owned per renderer so preview and export never share */
	cameraSpring: ZoomSpringState | null = null;
	lastCameraTimeTicks: number | null = null;
