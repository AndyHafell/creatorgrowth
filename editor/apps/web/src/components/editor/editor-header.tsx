...
// MemberAvatar (shared-account profile pic → main CG settings) parked for now —
// re-add <MemberAvatar /> to the nav below to bring it back.
...
// Agent 9 (magic-pass): single mount point for Auto Magic — coordinate before moving.
import { MagicPassButton } from "./magic-pass/magic-pass-button";
			...
			<DropdownMenu>
				<DropdownMenuTrigger asChild>
					<Button variant="ghost" size="icon" className="p-1 rounded-sm size-8">
						{/* Plain <img> + manual basePath prefix — next/image was rendering a broken placeholder */}
						<img
							src={`/editor${DEFAULT_LOGO_URL}`}
